...
export const team: Person[] = [
  {
    ...
    bio: 'Runs the studio behind Foundry PC and Homefront. Has formed the PC, placed the physician owner, and chased the roster-add more times than he would like.',
